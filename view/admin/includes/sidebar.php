      ...
      <div class="navbar-collapse">
          <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
              <ul class="nav" id="side-menu">
                  ...
                  <li>
                      <a href="sinhvien.php"><i class="fa fa-check-square-o nav_icon"></i>Quản lý sinh viên</a>
                  </li>
                  <li>
                    <a href="giaovien.php"><i class="fa fa-file-text-o nav_icon"></i>Quản lý giáo viên</a>
                  </li>
